        ...
        <div>
          ...
          >
            {places.map((item, index) => (
              <SwiperSlide
                key={index}
                className="!w-[230px] h-[340px]! lg:!w-[330px] lg:!h-[490px] px-5 lg:px-10 pb-5 lg:pb-10 pt-[58px]"
              >
                <div
                  className={`relative w-full overflow-hidden h-full px-4 py-6 rounded-2xl ${item.image_url}`}
