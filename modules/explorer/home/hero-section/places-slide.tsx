...
const PlacesSlide = ({ places }: PlacesSlideProps) => {
  ...
  return (
    <div className="h-full">
      <div className="relative bg-linear-to-r from-brand-orange/30  h-full">
            ...
            return (
              ...
              >
                <div className="relative w-full h-full flex items-end p-5">
                  ...
                  <div className="relative z-10 pb-12 pr-6">
                    <div className="text-brand-sand">
                      <p className="md:text-3xl font-display font-semibold">
                        {place.name}
                      </p>
                      <p className="pt-2 line-clamp-2 text-sm md:text-base">
                        {place.description}
                      </p>
                    </div>
                  </div>
