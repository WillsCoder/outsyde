      ...
      <div className="box">
        <div className="relative w-full overflow-hidden rounded-3xl bg-brand-orange/50 px-6 py-12 text-center sm:px-12 sm:py-16">
          ...
          <div className="relative">
            ...
            {status === "success" ? (
              <div className="mx-auto mt-8 max-w-md rounded-2xl bg-brand-sand px-6 py-6">
              ...
              >
                <input
                  ...
                  className="flex-1 rounded-full bg-white py-3 p-5 text-sm text-brand-night outline-none ring-brand-night/20 transition placeholder:text-brand-night/40 focus:ring-2"
                />
                <button
                  type="submit"
